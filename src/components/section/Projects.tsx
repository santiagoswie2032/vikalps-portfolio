...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      title: "VOS - x86 OS Kernel",
      description: "Built a minimal x86 operating system with a custom bootloader in Assembly that loads a C++ kernel. Implemented Interrupt Descriptor Table (IDT), interrupt handling, and structured modules for hardware communication.",
      technologies: ["C++", "Assembly", "OS Dev", "Bootloader"],
      icon: comingSoon,
      detailsUrl: socialLinks.repositories.projectTwo,
      githubUrl: socialLinks.repositories.projectTwo
    },
    {
      title: "ReachInbox Email Scheduler",
      description: "Built a backend service for scheduling and sending emails reliably at scale. Implemented distributed worker processing with configurable concurrency and Redis-backed rate limiting.",
      technologies: ["Node.js", "Redis", "Docker", "Nodemailer"],
      icon: comingSoon,
      detailsUrl: socialLinks.repositories.projectThree,
      githubUrl: socialLinks.repositories.projectThree
    },
    {
      title: "Personal Portfolio",
      description: "A highly interactive personal portfolio website featuring draggable elements, custom physics-based sticker animations, ASCII art morphing, and dark/light themes.",
      technologies: ["React", "TypeScript", "Tailwind CSS", "GSAP"],
      icon: comingSoon,
      detailsUrl: socialLinks.repositories.projectFour,
