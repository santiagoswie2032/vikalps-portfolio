...
export const colors = {
  ...
  // Special colors
  special: {
    dragMe: '#DC2626',       // Spider-Man red for drag me star
    aurora: {
      dark: '#DC2626',       // Red aurora for dark mode
      light: {
        1: '#FECACA',        // Light red aurora stop 1
        2: '#FEE2E2',        // Light red aurora stop 2
        3: '#FEF2F2',        // Light red aurora stop 3
      }
    }
  },
} as const;
